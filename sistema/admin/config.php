...
$desktop = $rowt['COUNT(*)'];	
		    ...
		    $QUERY5 = "SELECT COUNT(*) FROM cliques";
			$desk = mysqli_query($conn, $QUERY5);
			$row = mysqli_fetch_array($desk);
			$cliques = $row['COUNT(*)'];

			$QUERY6 = "SELECT COUNT(*) FROM bots";
			$b = mysqli_query($conn, $QUERY6);
			$rowx = mysqli_fetch_array($b);
			$robos = $rowx['COUNT(*)'];
...
<body class="">
  <div class="wrapper">
              ...
              <div class="card-header ">
                <div class="row">
                  <div class="col-sm-6 text-left">
                    ...
                    <h2 class="card-title text-danger">Configuração</h2>
                  </div>
   ...
   <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Zerar estatisticas do site</h5>
              </div>  
			  <div id="sumir" class="card-footer">
                <button onclick="zvisitas();" type="submit" class="btn btn-fill btn-primary">Cliques (<?php echo $cliques;?>)</button>
              </div>
			
           			  
             <div id="sumir" class="card-footer">
                <button onclick="zcell();" type="submit" class="btn btn-fill btn-primary">Mobile (<?php echo $mobile;?>)</button>
               
              </div>
			
              <div id="sumir" class="card-footer">
                <button onclick="zpc();" type="submit" class="btn btn-fill btn-primary">Desktop (<?php echo $desktop;?>)</button>
              </div>
			  
              <div id="sumir" class="card-footer">
                <button onclick="zrobo();" type="submit" class="btn btn-fill btn-primary">Robôs (<?php echo $robos;?>)</button>
              </div>
          ...
          <ul class="nav">
            <li class="nav-item">
              <a href="javascript:void(0)" class="nav-link">
                The Fake 2021 All Rights Reserved
              </a>
            </li>
